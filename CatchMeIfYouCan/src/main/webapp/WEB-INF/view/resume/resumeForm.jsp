			...
			<div class="container">
				...
				<div class="navbar-header page-scroll">
					...
					<input class="navbar-brand input-title" type="text"
						name="resumeTitle" id="id"
						placeholder="${resume.getResumeTitle()}">
				</div>
						<div>
		...
		<header>
			<div class="container">
				...
				<div class="info">
					...
					<div class="job">${resume.getJob1()}, ${resume.getJob2()},
						${resume.getJob3()}</div>
					<hr>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-4 col-lg-offset-2">
						<p>안녕하십니까? 데이터 분석역량과 개발역량을 갖춘 인재, 조경현입니다. 사용 가능 언어와 기슬로는 Java,
							Jsp, Spring, Mybatis, Python, Linux, R, HTML, Javascript, css,
							JQuery, BootStrap 등이 있습니다.</p>
					</div>
					<div class="col-lg-4">
					...
					<div class="col-lg-8 col-lg-offset-2">
						...
						<form action="<c:url value="/mail/send.do"/>" method=post>
							<div class="row control-group">
								<div
									...
									<label>Subject</label> <input type="text" class="form-control"
										name="subject" placeholder="subject" id="name" required
							...
							<div class="row control-group">
								<div
									class="form-group col-xs-12 floating-label-form-group controls">
									<label>Email Address</label> <input type="text" name="from"
					...
					<div class="row">
						<div class="col-lg-8 col-lg-offset-2">
							<div class="modal-body">
								...
								<img
									src="${pageContext.request.contextPath}${resume.getPortfolio6ImgPath()}"
									class="img-responsive img-centered" alt="" width=900 height=650>
								<p class=portfolio-info>
